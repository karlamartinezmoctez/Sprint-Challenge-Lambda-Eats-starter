...
"useRouteMatch" is useful when using <Route> so that you can get access to its match data. It matches the URL exactly like a <Route>.
2. How would you explain form validation to someone who has never programmed before?
Validation is a way of making sure that only correct format or values are inputed on the application. A good analogy is like when you go to buy alcohol, the cashiers validates that you are of age before you can make the purchase.
3. In 1-2 sentences, define end to end testing.
End-to-End testing is a technique use to test whether the flow of an application is correct from start to end. It allows to ensure that data integrity is maintaed between various system components and systems
